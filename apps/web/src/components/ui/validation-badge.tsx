...
const statusConfig: Record<ValidationStatus, { label: string; classes: string }> = {
  ...
  'station-validated': { label: 'Station Validated', classes: 'bg-blue-50 text-blue-700' },
  'externally-validated': { label: 'Externally Validated', classes: 'bg-green-50 text-green-700' },
};
